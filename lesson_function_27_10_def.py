...
# def get_tickets_data():  # зчитуємо дані по 3 класах місць
#     data = {}
#     for _ in range(3):
#         seat_class = input().strip()
#         price = float(input())
#         sold = int(input())
#         data[seat_class] = (price, sold)
#     return data

# # чи такий варіант:

# def calc_income(data):  # рахуємо дохід по кожному класу і загальний
#     income = {}
#     total = 0
#     for k, (price, sold) in data.items():
#         money = round(price * sold, 2)
#         income[k] = money
#         total += money
#     total = round(total, 2)
#     return income, total

# # приклади і пояснення для себе: 

# if __name__ == "__main__":
#     data = get_tickets_data()
#     result = calc_income(data)
#     print(result)

# # get_tickets_data() — читає вхідні дані (клас, ціна, кількість проданих) і формує словник, наприклад:
# # {'A': (20.5, 45), 'B': (15.75, 30), 'C': (10.55, 15)}

# # calc_income(data) — множить ціну на кількість для кожного класу, підсумовує і повертає:
# # ({'A': 922.5, 'B': 472.5, 'C': 158.25}, 1553.25)
...
# def check_card(n):
#     n = n.replace(" ", "")
#     if not n.isdigit() or len(n) <= 1: return "INVALID"
#     s = sum(int(d)*2 - 9 if i%2==1 and int(d)*2>9 else int(d)*2 if i%2==1 else int(d)
#            for i, d in enumerate(n[::-1]))
#     if s % 10: return "INVALID"
...
# print(check_card("4539 1488 0343 6467"))  # VISA
# print(check_card("8273 1232 7352 0569"))  # INVALID
# print(check_card("371449635398431"))      # AMEX
# print(check_card("5500005555555559"))     # MASTERCARD

# # варіант 2:

# check_card = lambda n: (
#     "INVALID" if not (n := n.replace(" ", "")).isdigit() or len(n) <= 1 or 
#     sum(
#         (d * 2 - 9 if i % 2 == 1 and (d := int(c)) * 2 > 9 
#          else d * 2 if i % 2 == 1 
#          else d)
#         for i, c in enumerate(n[::-1])
#     ) % 10
#     else "AMEX" if len(n) == 15 and n[:2] in ("34", "37")
#     else "MASTERCARD" if len(n) == 16 and n[:2] in ("51", "52", "53", "54", "55")
#     else "VISA" if len(n) in (13, 16) and n[0] == "4"
#     else "INVALID"
# )

# # прибирає пробіли

# # перевіряє, що тільки цифри

# # виконує алгоритм Луна

# # визначає тип картки (AMEX, MASTERCARD, VISA)
